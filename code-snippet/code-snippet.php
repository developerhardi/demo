...
Description: This is functions.php file of child theme. Here is different functions with functionalities.

Function 1 wpb_loadmap: In this, I am fetching addresses from MySql Databas and load data on google map with marker, as per address category type I am loading different marker on map.

Function 2 my_custom_fonts_new: In this, I am loading style for menu element.

Function 3 custom_shop_page_redirect: In this, Shop page redirect to new created Shop page.

Function 4 print_my_inline_script_custom: In this, loading inline script on footer. If website open from Mac device then "mac-os" named class added to the "body" tag.
